...
const SheetTrigger = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof SheetPrimitive.Trigger>>(
  (props, ref) => <SheetPrimitive.Trigger ref={ref} data-slot="sheet-trigger" {...props} />
);
SheetTrigger.displayName = 'SheetTrigger';

const SheetClose = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof SheetPrimitive.Close>>(
  (props, ref) => <SheetPrimitive.Close ref={ref} data-slot="sheet-close" {...props} />
);
SheetClose.displayName = 'SheetClose';

const SheetPortal = React.forwardRef<HTMLDivElement, React.ComponentProps<typeof SheetPrimitive.Portal>>(
