...
const DialogPortal = React.forwardRef<HTMLDivElement, React.ComponentProps<typeof DialogPrimitive.Portal>>(
  (props, ref) => <DialogPrimitive.Portal ref={ref} data-slot="dialog-portal" {...props} />
);
...
const DialogContent = React.forwardRef<HTMLDivElement, React.ComponentProps<typeof DialogPrimitive.Content>>(
